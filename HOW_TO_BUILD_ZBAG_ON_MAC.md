# Building zbag on macOS

This guide walks you through setting up your Mac to build zbag. No programming experience required.
...
Now we install the tools needed to build zbag.
...
## Step 7: Download and Build zbag
...
```
apps/zbag-app-tauri/src-tauri/target/release/bundle/macos/zbag.app
```

You can open this folder in Finder by running:

```bash
open apps/zbag-app-tauri/src-tauri/target/release/bundle/macos/
```

Drag **zbag.app** to your Applications folder to install it.
