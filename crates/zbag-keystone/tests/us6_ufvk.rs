...
fn parses_mainnet_and_testnet_ufvk_and_extracts_network() {
    ...
    let parsed_main = zbag_keystone::ufvk::parse_ufvk(&encoded_main).expect("parse mainnet ufvk");
    ...
    let parsed_test = zbag_keystone::ufvk::parse_ufvk(&encoded_test).expect("parse testnet ufvk");
...
fn rejects_invalid_ufvk() {
    let err = zbag_keystone::ufvk::parse_ufvk("not-a-ufvk").expect_err("invalid ufvk");
