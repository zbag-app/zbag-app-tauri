...
use zbag_core::domain::{JobId, JobProgress, JobState, JobType, Network};
use zbag_core::ipc::v1::common::SCHEMA_VERSION;
use zbag_core::ipc::v1::events::{JobProgressEvent, TransactionChangedEvent};
...
pub struct SendJobContext {
    ...
    pub tor_manager: Option<Arc<zbag_tor::TorManager>>,
}
...
async fn run_send_job(
    ...
    if let Some(handler) = on_tx_changed.as_ref() {
        use zbag_core::domain::{TransactionInfo, TransactionStatus, TransactionType};
