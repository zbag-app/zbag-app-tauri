...
use zbag_core::ipc::v1::commands::job::{
...
use zbag_core::ipc::v1::commands::wallet::{BackupChallenge, ReauthPurpose};
use zbag_core::ipc::v1::common::SCHEMA_VERSION;
use zbag_core::ipc::v1::events::WalletStatusEvent;
use zbag_core::permissions::{
...
impl WalletManager {
    ...
    pub fn create_keystone_wallet(
        ...
        let parsed = zbag_keystone::ufvk::parse_ufvk(ufvk)
    ...
    pub fn import_ufvk(
            ...
            .context("failed to list wallet accounts")?
        {
            ...
            // An account may have both (e.g., Keystone accounts with key_source="zbag:N"
...
fn default_wallets_root() -> anyhow::Result<PathBuf> {
    ...
    Ok(PathBuf::from(home).join(".zbag").join("wallets"))
}
...
pub async fn fetch_birthday_height_for_new_wallet(
    ...
    let client = match tor_manager {
        Some(tor) => zbag_network::grpc_client::GrpcClient::new_with_tor(grpc_url, tor),
