...
import { listTransactions, reauthWallet, retryBroadcast } from '../services/ipc';
import { onTransactionChanged } from '../services/events';
  ...
  return (
    <div style={{ display: 'grid', gap: 12, padding: 16, maxWidth: 920 }}>
      ...
      <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
        <button type="button" onClick={() => void load(offset)} disabled={loading || activeAccountId == null}>
          Refresh
        </button>
