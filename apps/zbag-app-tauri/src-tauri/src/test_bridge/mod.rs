...
//! enabling Playwright and Claude Code (via Chrome MCP) to test zbag against the real
...
use zbag_core::ipc::v1::commands::sync::{
...
const RATE_LIMITED_SENSITIVE_COMMANDS: [&str; 1] = ["zbag_view_seed_phrase"];
...
fn parse_allowed_origins() -> Vec<HeaderValue> {
    ...
    if let Ok(raw) = std::env::var("ZBAG_TEST_BRIDGE_ALLOWED_ORIGINS") {
...
async fn invoke_command(
    ...
    match command.as_str() {
        ...
        "zbag_get_wallet_status" => dispatch::<GetWalletStatusRequest, GetWalletStatusResponse>(
            &state,
            body.request,
        ...
        "zbag_view_seed_phrase" => dispatch::<ViewSeedPhraseRequest, ViewSeedPhraseResponse>(
            &state,
            body.request,
        ...
        // Backup commands
        "zbag_get_backup_challenge" => dispatch::<
        ...
        "zbag_restore_wallet" => dispatch::<RestoreWalletRequest, RestoreWalletResponse>(
            &state,
            body.request,
            restore_wallet_impl,
        ),
        ...
        "zbag_retry_broadcast" => dispatch::<RetryBroadcastRequest, RetryBroadcastResponse>(
            &state,
            body.request,
            retry_broadcast_impl,
        ),
        "zbag_list_transactions" => dispatch::<ListTransactionsRequest, ListTransactionsResponse>(
            &state,
            body.request,
        ...
        "zbag_build_signing_request" => dispatch::<
            BuildSigningRequestRequest,
            BuildSigningRequestResponse,
        >(&state, body.request, |s, req| {
            build_signing_request_impl(s, req)
        }),
        "zbag_finalize_signing" => dispatch::<FinalizeSigningRequest, FinalizeSigningResponse>(
            &state,
            body.request,
            finalize_signing_impl,
        ),
        "zbag_create_keystone_wallet" => dispatch::<
        ...
        // Swap commands
        "zbag_request_swap_quote" => dispatch::<RequestSwapQuoteRequest, RequestSwapQuoteResponse>(
            &state,
            body.request,
        ...
        "zbag_get_swap_status" => dispatch::<GetSwapStatusRequest, GetSwapStatusResponse>(
            &state,
            body.request,
        ...
        // Tor commands
        "zbag_set_tor_enabled" => dispatch::<SetTorEnabledRequest, SetTorEnabledResponse>(
            &state,
            body.request,
        ...
        "zbag_set_default_server" => dispatch::<SetDefaultServerRequest, SetDefaultServerResponse>(
            &state,
            body.request,
        ...
        // Logs
        "zbag_get_log_location" => dispatch::<GetLogLocationRequest, GetLogLocationResponse>(
            &state,
            body.request,
        ...
        "zbag_get_fiat_settings" => dispatch::<GetFiatSettingsRequest, GetFiatSettingsResponse>(
            &state,
            body.request,
            get_fiat_settings_impl,
        ),
        "zbag_set_fiat_settings" => dispatch::<SetFiatSettingsRequest, SetFiatSettingsResponse>(
            &state,
            body.request,
        ...
        "zbag_get_sync_progress" => dispatch::<GetSyncProgressRequest, GetSyncProgressResponse>(
            &state,
            body.request,
