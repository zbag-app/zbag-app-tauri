...
#[tauri::command(rename = "zbag_add_server")]
pub fn zbag_add_server(
...
#[tauri::command(rename = "zbag_set_default_server")]
pub fn zbag_set_default_server(
    state: State<'_, AppState>,
...
#[tauri::command(rename = "zbag_list_servers")]
pub fn zbag_list_servers(
    state: State<'_, AppState>,
...
#[tauri::command(rename = "zbag_test_server")]
pub fn zbag_test_server(
    state: State<'_, AppState>,
