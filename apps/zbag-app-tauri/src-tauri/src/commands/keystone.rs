...
#[tauri::command(rename = "zbag_import_ufvk")]
pub fn zbag_import_ufvk(
...
#[tauri::command(rename = "zbag_build_signing_request")]
pub fn zbag_build_signing_request(
    state: State<'_, AppState>,
...
#[tauri::command(rename = "zbag_finalize_signing")]
pub fn zbag_finalize_signing(
    state: State<'_, AppState>,
...
#[tauri::command(rename = "zbag_create_keystone_wallet")]
pub fn zbag_create_keystone_wallet(
    state: State<'_, AppState>,
