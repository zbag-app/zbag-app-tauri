...
#[tauri::command(rename = "zbag_start_send_job")]
pub fn zbag_start_send_job<R: Runtime>(
...
#[tauri::command(rename = "zbag_start_shield_job")]
pub fn zbag_start_shield_job<R: Runtime>(
    app: tauri::AppHandle<R>,
    state: State<'_, AppState>,
...
#[tauri::command(rename = "zbag_cancel_job")]
pub fn zbag_cancel_job(
    state: State<'_, AppState>,
...
#[tauri::command(rename = "zbag_get_job_status")]
pub fn zbag_get_job_status(
    state: State<'_, AppState>,
...
#[tauri::command(rename = "zbag_list_jobs")]
pub fn zbag_list_jobs(
    state: State<'_, AppState>,
