...
use zbag_core::domain::{Network, WalletInfo, WalletLockStatus};
...
impl CliAppState {
    ...
    pub fn new(data_dir: &Path, enable_tor: bool) -> Result<Self> {
        ...
        let tor_manager = if enable_tor {
            ...
            let tor_state =
                zbag_engine::db::tor_meta::get_tor_state(wallet_manager.app_db().conn())
                    .map_err(|e| anyhow::anyhow!(e))?;

            let manager = Arc::new(zbag_tor::TorManager::new(
