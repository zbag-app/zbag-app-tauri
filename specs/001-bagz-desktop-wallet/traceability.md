# Traceability: bagZ Desktop Wallet
...
| **NFR-002.a** CEF emits no non-loopback traffic | `scripts/check-cef-network-hardening.sh`; `apps/bagz-app-tauri/src-tauri/tests/cef_runtime_args.rs`; `cargo xtask cef-smoketest` |
