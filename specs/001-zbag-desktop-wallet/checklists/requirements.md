# Specification Quality Checklist: zbag Desktop Wallet
...
- Specification derived from consolidated design docs in `specs/001-zbag-desktop-wallet/` and `.specify/memory/constitution.md`
- Requirements → tasks mapping: `specs/001-zbag-desktop-wallet/traceability.md`
