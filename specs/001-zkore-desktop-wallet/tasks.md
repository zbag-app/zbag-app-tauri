...
- [ ] T082c [US1] Emit BalanceChangedEvent to zkore://balance channel in crates/zkore-engine whenever the computed Balance for an account changes (at minimum after sync scan batches and after completed send/shield operations)
