...
- This repo is spec-first. The canonical docs live in `README.md`, `changes.md`, `CLAUDE.md`, and `docs/` (constitution, plan, task).
...
- Docs: keep headings consistent and update both `docs/` and `specs/` when scope changes.
...
- Follow the Constitution in `docs/constitution.md`, especially for private disclosure.
